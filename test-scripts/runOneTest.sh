...
testname=complexRedirection_illegal #can change name to debug individually
BATCHPATH=/stage/classes/archive/2022/winter/15400-1/proj/p4/batch-files
OUTPUTPATH=/stage/classes/archive/2022/winter/15400-1/proj/p4/expected-output
